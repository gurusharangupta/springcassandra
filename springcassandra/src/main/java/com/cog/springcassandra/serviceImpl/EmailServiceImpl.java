...
public class EmailServiceImpl implements EmailService{
    ...
    {  
        ...
        try{  
	        ...
	        helper.setFrom("useroct2017@outlook.com");
	        ...
	        // attach the file  
	        FileSystemResource file = new FileSystemResource(new File("C:\\Users\\hiresmart\\eclipse-workspace\\springcassandra\\springcassandra\\src\\main\\resources\\static\\pdf\\sample.pdf"));  
